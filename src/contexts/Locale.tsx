...
const TRANSLATIONS = {
  ...
  'tutorial.s1.desc':       { ka: 'mipove.me — სვაიპით იპოვე შენი ახალი ოთხფეხა მეგობარი.', en: 'mipove.me — swipe to find your new four-legged friend.' },
  ...
  'admin.hidden.local':     { ka: '{name} ლოკალურად ამოღებულია სიიდან', en: '{name} removed locally' },
